	...
	<div class="bohemcars-mobile-home" data-bohemcars-search-form={activeMobileAction?.mode ?? 'buy'}>
		...
		<section class="bohemcars-mobile-hero" aria-label={mobileHeading}>
			<div class="container">
				...
				<div
					class={`bohemcars-mobile-hero__search-module bohemcars-mobile-hero__search-module--${mobileTabsVariant}`}
				>
					<div class="bohemcars-mobile-hero__box">
						<div
		...
		{#if mobileSearchOpen && activeMobileAction}
			...
			>
				...
				>
					...
					<div class="bohemcars-home-search-overlay__scroll">
...
<style>
	...
	@media (max-width: 767.98px) {
		...
		.bohemcars-mobile-hero__box {
			display: contents;
		}

		.bohemcars-mobile-hero__search-module--boxed .bohemcars-mobile-hero__box {
			display: grid;
			gap: 9px;
			border-radius: 16px;
		...
		.bohemcars-mobile-hero__search-module--boxed .bohemcars-mobile-hero__tabs {
			background: #eef1ea;
			padding: 3px;
		}

		.bohemcars-mobile-hero__search-module--boxed .bohemcars-mobile-hero__tab {
			color: rgba(20, 33, 15, 0.62);
		}

		.bohemcars-mobile-hero__search-module--boxed .bohemcars-mobile-hero__tab.active {
			background: #14210f;
			box-shadow: none;
			color: #ffffff;
		}
		...
		.bohemcars-mobile-hero__search-module--boxed .bohemcars-mobile-hero__search {
			height: 52px;
		...
		.bohemcars-home-search-overlay__bar {
			display: flex;
			align-items: center;
			justify-content: space-between;
			gap: 12px;
		...
		.bohemcars-home-search-overlay__close {
			display: flex;
			width: 40px;
			height: 40px;
			align-items: center;
		...
		.bohemcars-home-search-overlay__scroll {
			display: grid;
			min-height: 0;
			gap: 13px;
			align-content: start;
		...
		.bohemcars-home-search-overlay__scroll::-webkit-scrollbar {
			display: none;
		}
		...
		.bohemcars-home-search-drawer__form > .bohemcars-home-search-drawer__field {
			margin: 13px 16px 0;
		}
