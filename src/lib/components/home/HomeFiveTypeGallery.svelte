<script lang="ts">
	...
	let { cards, copy }: { cards: HomeFiveTypeCard[]; copy: HomePageCopy } = $props();
</script>

<section class="bohemcars-type-gallery relative bg-white py-100">
...
<style>
	...
	.bohemcars-type-gallery :global(.title-section) {
		align-items: center;
		display: flex;
